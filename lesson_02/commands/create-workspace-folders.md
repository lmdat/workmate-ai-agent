...
# Tạo file opencode.jsonc

- Tạo file `.opencode/opencode.jsonc` có nội dung (UTF-8) như sau:
...
- Chỉ tạo mới nếu file `opencode.jsonc` chưa có, không được ghi đè file hiện tại.
